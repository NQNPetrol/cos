<x-app-layout>
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        <div class="bg-white border-b border-slate-200 sticky top-0 z-10">
            <div class="container mx-auto px-6 py-4">
                <nav class="flex items-center space-x-2 text-sm text-slate-600 mb-2">
                    <a href="{{ route('eventos.index') }}" class="hover:text-blue-600 transition-colors">
                    ...
                    <span>/</span>
                    <span class="text-slate-900 font-medium">Vista Previa del Reporte del Evento #{{ $evento->id }}</span>
                </nav>
                ...
                <div class="xl:col-span-1">
                    <div class="bg-white rounded-2xl shadow-xl border border-slate-200 mb-6 overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <form action="{{ route('eventos.reporte.generate', $evento) }}" method="POST">
                                @csrf
                                <button type="submit" class="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-[1.02] shadow-lg hover:shadow-xl flex items-center justify-center group">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-3 max-h-96 overflow-y-auto">
                                ...
                                <div class="group border border-slate-200 rounded-lg p-4 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
                        <div class="p-6 text-center">
                            ...
                            <h3 class="text-lg font-medium text-slate-900 mb-2">Sin reportes generados</h3>
    ...
    <!-- Toast notifications -->
    @if(session('success'))
    <div id="toast-success" class="fixed bottom-4 right-4 flex items-center w-full max-w-xs p-4 mb-4 text-green-500 bg-white rounded-lg shadow-lg z-50" role="alert">
        ...
        <button type="button" onclick="document.getElementById('toast-success').remove()" class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8">
