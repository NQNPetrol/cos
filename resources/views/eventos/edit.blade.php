        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-zinc-900 text-gray-100 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-100 dark:text-gray-100">
                    ...
                    <div id="debug-output" class="mb-4 p-3 bg-zinc-800 text-sm text-gray-300 rounded-md"></div>
                    ...
                    <form id="evento-edit-form" action="{{ route('eventos.update', $evento) }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                        ...
                        <div class="bg-zinc-700 p-4 rounded-lg">
                            ...
                            <textarea name="descripcion" id="descripcion"
                                      class="mt-1 block w-full rounded-md bg-zinc-600 border-zinc-500 text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2">{{ old('descripcion', $evento->descripcion) }}</textarea>
                        </div>
                        ...
                        <div class="bg-zinc-700 p-4 rounded-lg">
                            ...
                            <textarea name="observaciones" id="observaciones" rows="3"
                                      class="mt-1 block w-full rounded-md bg-zinc-600 border-zinc-500 text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2">{{ old('observaciones', $evento->observaciones) }}</textarea>
                        </div>
            ...
            newRow.innerHTML = `
                ...
                <div class="campos-afectado ${tipo === 'afectado/victima' ? '' : 'hidden'}">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="personas_nombre[]" value="${nombre}" class="block w-full rounded-md bg-zinc-600 border-zinc-500 text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2" placeholder="Nombre completo">
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="number" name="personas_nro_doc[]" value="${nroDoc}" class="block w-full rounded-md bg-zinc-600 border-zinc-500 text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2" placeholder="Número de documento">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-300 mb-2">Teléfono</label>
                            <input type="text" name="personas_nro_telefono[]" value="${nroTelefono}" class="block w-full rounded-md bg-zinc-600 border-zinc-500 text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2" placeholder="Número de teléfono">
                        </div>
                    </div>
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-300 mb-2">Relación con el Evento</label>
                        <textarea name="personas_relacion_evento[]" rows="2" class="block w-full rounded-md bg-zinc-600 border-zinc-500 text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2" placeholder="Describa la relación de esta persona con el evento">${relacionEvento}</textarea>
                    </div>
                </div>
                ...
                <div class="campos-sospechoso ${tipo === 'sospechoso' ? '' : 'hidden'}">
                    <div class="mb-4">
                        ...
                        <textarea name="personas_descripcion_fisica[]" rows="2" class="block w-full rounded-md bg-zinc-600 border-zinc-500 text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2" placeholder="Describa las características físicas del sospechoso">${descripcionFisica}</textarea>
                    </div>
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-300 mb-2">Comportamiento Observado</label>
                        <textarea name="personas_comportamiento_observado[]" rows="2" class="block w-full rounded-md bg-zinc-600 border-zinc-500 text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2" placeholder="Describa el comportamiento observado del sospechoso">${comportamientoObservado}</textarea>
                    </div>
                </div>
            `;
