<div id="userMenu" class="modern-dropdown hidden" style="right: 0; margin-top: 8px; width: 300px;">
    ...
    <div style="padding: 8px 0;">
        <a href="{{ route('profile.show') }}" class="modern-sidebar-item" style="text-decoration: none; display: block;">
        ...
        <a href="#" class="modern-sidebar-item" style="text-decoration: none; display: block;">
            <svg class="modern-sidebar-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('settings.profile') }}" class="modern-sidebar-item" style="text-decoration: none; display: block;">
            <svg class="modern-sidebar-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
