...
<nav class="modern-top-nav">
    ...
    <div class="modern-top-nav-center" role="navigation" aria-label="Navegación principal">
        @if($isClient)
            ...
            @php
                $userClienteNav = auth()->user()->clientes()->first();
                $hasFlytbaseSite = $userClienteNav ? \App\Models\FlytbaseSite::where('cliente_id', $userClienteNav->id)->exists() : false;
            @endphp
            @if($hasFlytbaseSite)
            ...
            @endif
            <button class="modern-top-nav-button" data-dashboard="supervisores-recorridos" data-route="{{ route('client.supervisores.index') }}" title="Supervisores y Recorridos">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                </svg>
            </button>
            <button class="modern-top-nav-button" data-dashboard="administracion-cliente" data-route="{{ route('client.empresas-asociadas.index') }}" title="Sistema y Configuración">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @else
            ...
            <button class="modern-top-nav-button" data-dashboard="administracion" data-route="{{ route('rodados.admin-dashboard') }}" title="Administración">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
