        ...
        <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden bg-white/10">
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    <!-- Account Management -->
                    <x-responsive-nav-link href="{{ route('client.profile.show') }}" :active="request()->routeIs('profile.show')">
                        {{ __('Profile') }}
                    </x-responsive-nav-link>
                ...
                <nav class="space-y-2">
                    ...
                    <div>
                        ...
                        <div id="submenuDrones" class="ml-4 mt-2 space-y-1 hidden animate-slideDown">
                            ...
                            <a href="{{ route('client.misiones') }}" class="flex items-center space-x-3 text-gray-600 hover:text-blue-600 hover:bg-blue-50 p-3 rounded-lg transition-all duration-200">
