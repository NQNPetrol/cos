                ...
                <nav class="space-y-2">
                    ...
                    <div>
                        ...
                        <div id="submenuEventos" class="ml-4 mt-2 space-y-1 hidden animate-slideDown">
                            <a href="{{ route('eventos.index-guest') }}" class="flex items-center space-x-3 text-gray-600 hover:text-blue-600 hover:bg-blue-50 p-3 rounded-lg transition-all duration-200">
                                <i class="bi bi-search text-lg"></i>
                                <span>Listado</span>
                            </a>
                            <a href="{{ route('eventos.create-guest') }}" class="flex items-center space-x-3 text-gray-600 hover:text-blue-600 hover:bg-blue-50 p-3 rounded-lg transition-all duration-200">
                                <i class="bi bi-plus text-lg"></i>
                                <span>Nuevo</span>
                            </a>
                            <a href="{{ route('seguimientos.index-guest') }}" class="flex items-center space-x-3 text-gray-600 hover:text-blue-600 hover:bg-blue-50 p-3 rounded-lg transition-all duration-200">
                                <i class="bi bi-search text-lg"></i>
                    ...
                    <div>
                        ...
                        <div id="submenuPatrullas" class="ml-4 mt-2 space-y-1 hidden animate-slideDown">
                            <a href="{{ route('patrullas.index-guest') }}" class="flex items-center space-x-3 text-gray-600 hover:text-blue-600 hover:bg-blue-50 p-3 rounded-lg transition-all duration-200">
                                <i class="bi bi-gear text-lg"></i>
                                <span>Administrar Patrullas</span>
                            </a>
                            <a href="{{ route('patrullas.location-guest') }}" class="flex items-center space-x-3 text-gray-600 hover:text-blue-600 hover:bg-blue-50 p-3 rounded-lg transition-all duration-200">
