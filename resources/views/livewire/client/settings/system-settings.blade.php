<div class="modern-settings-container">
    ...
    <div class="modern-settings-layout">
        ...
        <div class="modern-settings-nav">
            <a href="{{ route('client.settings.user-profile') }}" class="modern-settings-nav-item">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
                <span>{{ __('Perfil') }}</span>
            </a>
            <a href="{{ route('client.settings.system') }}" class="modern-settings-nav-item active">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="modern-settings-content">
            ...
            <div class="modern-settings-section">
                ...
                <div class="modern-quick-links">
                    <a href="{{ route('client.settings.user-profile') }}" class="modern-quick-link">
                    ...
                    <a href="{{ route('client.dashboard') }}" class="modern-quick-link">
                        <div class="modern-quick-link-icon">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="modern-quick-link-text">
                            <span class="modern-quick-link-title">{{ __('Dashboard') }}</span>
                            <span class="modern-quick-link-desc">{{ __('Volver al inicio') }}</span>
                        </div>
                    </a>
                </div>
            </div>
