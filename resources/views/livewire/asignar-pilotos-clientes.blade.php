<div class="bg-gray-900 rounded-lg">
    <div>
        ...
        <div class="bg-gray-800 rounded-lg border border-gray-600">
            ...
            <div class="rounded-lg">
                <h3 class="text-lg font-semibold text-gray-100 p-6 border-b border-gray-600">
                                ...
                                <div class="p-6">
                                    <div class="flex items-center justify-between mb-4">
                                        <div>
                                            <h4 class="text-lg font-medium text-gray-100">
                                                {{ $piloto->nombre }}
                                                @if($piloto->user)
                                                    <span class="text-gray-400 text-sm">({{ $piloto->user->name }})</span>
                                                @endif
                                            </h4>
                                            <p class="text-gray-400 text-sm">Token: {{ Str::limit($piloto->token, 20) }}</p>
                                        </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                        @foreach($asignaciones[$piloto->id] as $clienteId)
                                            ...
                                            @endphp
                                            @if($cliente)
                                                <div class="flex items-center justify-between bg-gray-700 rounded-lg p-3 border border-gray-600">
                                                    <span class="text-gray-300 font-medium">{{ $cliente->nombre }}</span>
                                                    <button type="button" 
                ...
                @else
                    <div class="p-8 text-center">
                        ...
                        <h4 class="text-lg font-medium text-gray-400 mb-2">No hay asignaciones</h4>
