<x-app-layout>
    <div class="max-w-5xl mx-auto p-6 bg-gray-900 text-gray-50 rounded-lg shadow">
        ...
        <form action="{{ route('clientes.update', $cliente->id) }}" method="POST" class="bg-gray-800 rounded-lg p-6 border border-gray-700" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre', $cliente->nombre) }}"
                           class="w-full bg-gray-900 border border-gray-700 text-gray-200 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
