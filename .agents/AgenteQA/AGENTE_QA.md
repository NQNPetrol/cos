...
# Puede ser invocado por el AGENTE_CEO, el AGENTE_DEV al finalizar una versión,
...
para que el AGENTE_DEV los solucione.
...
> Stack: Laravel 12 + Pest. Entorno: `.env.testing` con base `cos_test`.
...
> Navegar como **admin** primero, luego como **cliente** si el scope lo requiere.
